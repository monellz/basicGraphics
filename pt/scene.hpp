...
public:
    ...
    Scene(){
        ...
        objs.push_back(new Sphere(objs.size(),13,V3(55,13,47),       V3(),V3(1,1,1)*.999, SPEC)); 
        //objs.push_back(new Sphere(objs.size(),16.5,V3(20,40,60),       V3(),"marble.bmp", DIFF)); 
        objs.push_back(new Sphere(objs.size(),16.5,V3(73,16.5,78),       V3(), V3(1,1,1) * 0.999, REFR));
        objs.push_back(new Sphere(objs.size(),10,V3(60,10,90),       V3(), "marble.bmp", DIFF));
        //lighter =new Sphere(objs.size(),30, V3(40,131.6-.27,81.6),V3(12,12,12),  V3(), DIFF); //Lite 原
        lighter =new Sphere(objs.size(),60, V3(40,161.6-.27,81.6),V3(1,1,1) * 6,  V3(), DIFF); //Lite 
    ...
    Photon emitPhoton(int cnt) {
        ...
        pt.pos = r.o;
        pt.dir = r.d;
        //pt.power = lighter->material.e * 4 * PI * PI * lighter->rad * lighter->rad / cnt; //原
