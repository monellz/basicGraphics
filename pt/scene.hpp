...
public:
    ...
    Scene(){
        ...
        lighter =new Sphere(objs.size(),30, V3(25,131.6-0.27,81.6),V3(12,12,12),  V3(), DIFF); //Lite 
        ...
        */
        ...
        objs.push_back(new Plane(objs.size(),V3(0,1,0),81.6,V3(),"sky.jpeg",DIFF));  //Top
    ...
    void readObj(std::string fn, const V3& bias) {
        //读取obj文件并放入objs中
